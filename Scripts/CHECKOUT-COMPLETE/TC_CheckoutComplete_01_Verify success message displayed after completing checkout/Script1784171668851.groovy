...
WebUI.verifyElementPresent(findTestObject('Checkout_Complete/lbl_CheckoutHeader'), 3)
WebUI.verifyElementPresent(findTestObject('Checkout_Complete/mssg_success'), 3)
