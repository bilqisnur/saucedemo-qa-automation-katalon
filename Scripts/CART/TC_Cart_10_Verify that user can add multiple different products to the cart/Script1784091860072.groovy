...
String expectedProductName1 = WebUI.getText(findTestObject('Catalog/titleProduct1'))
String expextedProductName2 = WebUI.getText(findTestObject('Catalog/titleProduct2'))

// Step 2: Add produk ke cart
WebUI.click(findTestObject('Catalog/btn_add to cart'))

WebUI.click(findTestObject('Catalog/btn_add to cart2'))
...
WebUI.verifyElementText(findTestObject('Cart/lbl_product'), expectedProductName1)
WebUI.verifyElementText(findTestObject('Cart/lbl_product'), expectedProductName1)
