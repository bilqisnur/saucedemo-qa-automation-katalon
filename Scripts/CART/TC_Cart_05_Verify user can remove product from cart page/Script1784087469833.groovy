...
// Step 1: Simpan data produk dari catalog 
...
WebUI.verifyElementPresent(findTestObject("Cart/lbl_product"), 5)

WebUI.click(findTestObject('Cart/btn_remove'))

WebUI.delay(5)

WebUI.verifyElementNotPresent(findTestObject("Cart/lbl_product"), 7)
